  ...
  return (
    <article id="main-content" className="mx-auto max-w-3xl px-4 py-16 md:pr-[180px] lg:pr-[220px] xl:pr-[400px] 2xl:pr-[480px] md:max-w-none md:ml-6 lg:ml-12">
      ...
      <section className="mb-16">
        <h2 className="font-display text-xl md:text-2xl font-medium mb-6 text-center md:text-left">
          Technical Skills
        </h2>
        <div className="space-y-5 text-xs md:text-base text-muted-foreground">
          <div>
          ...
          <div>
            <h3 className="text-sm md:text-base text-foreground font-medium mb-1 text-center md:text-left">Development</h3>
            <p>
      ...
      {/* Approach Section */}
      <section className="mb-16">
        <h2 className="font-display text-xl md:text-2xl font-medium mb-6 text-center md:text-left">Approach</h2>
        <div className="space-y-6 text-xs md:text-base text-muted-foreground">
          <div>
            <h3 className="text-sm md:text-base text-foreground font-medium mb-1 text-center md:text-left">
      ...
      {/* Education Section */}
      <section className="mb-16">
        <h2 className="font-display text-xl md:text-2xl font-medium mb-6 text-center md:text-left">Education</h2>
        <div className="space-y-6 text-xs md:text-base text-muted-foreground text-left">
          <div>
      ...
      <section className="mb-12">
        ...
        <div className="space-y-4 text-xs md:text-base text-muted-foreground">
