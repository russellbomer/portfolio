...
function GumroadIcon({ className }: { className?: string }) {
  return (
    <svg
      ...
      className={className}
    >
      <path d="M12 0C5.372 0 0 5.372 0 12s5.372 12 12 12 12-5.372 12-12S18.628 0 12 0zm0 19.2c-3.974 0-7.2-3.226-7.2-7.2S8.026 4.8 12 4.8c2.34 0 4.418 1.11 5.76 2.838L15.6 9.196A3.593 3.593 0 0 0 12 7.2c-2.648 0-4.8 2.152-4.8 4.8s2.152 4.8 4.8 4.8c1.88 0 3.508-1.085 4.322-2.676H12v-2.4h6.959c.028.243.041.49.041.741 0 3.974-3.226 7.2-7.2 7.2h.2z" />
    </svg>
  );
}
...
const socialLinks = [
  ...
  {
    label: "Gumroad",
    href: "https://russellbomer.gumroad.com/",
    icon: GumroadIcon,
  },
];
